            ...
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading"> Add New Payment Type</div>
                    <div class="panel-body">
                     ...
                     @if(session('error'))
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('/settings/payment/add_payment_submission') }}">
                                                    {{ csrf_field() }}
                                                    <br>
                            ...
                            <div class="form-group{{ $errors->has('payment_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4">
                                    <input id="payment_name" type="text" class="form-control"
                                           name="payment_name" value="{{ old('payment_name') }}"   autofocus>
                            ...
                            <div class="form-group{{ $errors->has('payment_description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4">
                                    <textarea  rows="6" cols="5" id="payment_description" class="form-control"
                                               name="payment_description" value="{{ old('payment_description') }}"   autofocus>
                                    </textarea>
